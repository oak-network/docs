---
sidebar_label: Keep-What's-Raised Campaign
sidebar_position: 4
---
...
:::info Prerequisites
Your platform must be enlisted with the Keep-What's-Raised implementation registered and approved — see [Platform Enlistment](/docs/contracts-sdk/examples/platform-enlistment).
:::
...
- [Keep-What's-Raised Treasury](/docs/contracts-sdk/keep-whats-raised)
