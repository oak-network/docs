---
sidebar_label: Payment Treasury Flow
sidebar_position: 5
---
...
:::info Prerequisites
Your platform must be enlisted with the PaymentTreasury (or TimeConstrainedPaymentTreasury) implementation registered and approved — see [Platform Enlistment](/docs/contracts-sdk/examples/platform-enlistment).
:::
...
- [Payment Treasury](/docs/contracts-sdk/payment-treasury)
