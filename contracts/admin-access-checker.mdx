...
- [CampaignAccessChecker](/contracts/campaign-access-checker) - Campaign-level access control
- [GlobalParams](/contracts/global-params) - Admin address management
- [PausableCancellable](/contracts/pausable-cancellable) - Emergency controls
