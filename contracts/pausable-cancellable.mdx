...
- [CampaignAccessChecker](/contracts/campaign-access-checker) - Access control using this state
- [BaseTreasury](/contracts/base-treasury) - Uses these modifiers
- [CampaignInfo](/contracts/campaign-info) - Implements pause/cancel functionality
