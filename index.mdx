...
<div className="oak-trust-bar">
  <div className="oak-trust-group">
    ...
    <span className="oak-trust-logos">
      <img className="oak-trust-logo" src="/images/kickstarter.png" alt="Kickstarter" />
      <img className="oak-trust-logo oak-logo-a16z" src="/images/a16z.png" alt="a16z crypto" />
    </span>
  </div>
  ...
  <div className="oak-trust-group">
    ...
    <span className="oak-trust-logos">
      <img className="oak-trust-logo" src="/images/open-zeppelin.png" alt="OpenZeppelin" />
    </span>
  </div>
</div>
