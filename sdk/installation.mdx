...
|---|---|---|
| `sandbox` | `https://sandbox-payments.oaknetwork.org` | Allowed |
| `production` | `https://payments.oaknetwork.org` | Blocked |
...
> For a full breakdown of environment behavior, sandbox-only restrictions, and the `@SandboxOnly` decorator, see [Environments](/sdk/environments).
