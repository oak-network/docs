...
if (tokenResult.ok) {
  ...
  fetch('https://sandbox-payments.oaknetwork.org/api/v1/some-endpoint', {
...
| `retryOptions` | `Partial<RetryOptions>` | No | Override default [retry behavior](/sdk/error-handling#retry-configuration) |
