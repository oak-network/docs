...
- [CampaignInfo](/contracts-sdk/campaign-info) — the campaign that the treasury serves
- [PaymentTreasury](/contracts-sdk/payment-treasury) — fiat payment treasury type
- [AllOrNothing](/contracts-sdk/all-or-nothing) — all-or-nothing crowdfunding treasury type
- [KeepWhatsRaised](/contracts-sdk/keep-whats-raised) — keep-what's-raised treasury type
