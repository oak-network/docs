...
**Two treasury variants, one SDK method**
...
- [CampaignInfo](/contracts-sdk/campaign-info) — the campaign this treasury belongs to
- [GlobalParams](/contracts-sdk/global-params) — line item types and fee configuration
