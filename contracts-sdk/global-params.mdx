...
- [CampaignInfoFactory](/contracts-sdk/campaign-info-factory) — uses GlobalParams for campaign creation
- [Utilities](/contracts-sdk/utilities) — `keccak256`, `toHex`, and other encoding helpers
- [Error Handling](/contracts-sdk/error-handling) — decoding `GlobalParams*` revert errors
